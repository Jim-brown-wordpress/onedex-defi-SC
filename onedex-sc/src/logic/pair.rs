    ...
    + crate::event::EventModule
{
    ...
    fn enable_swap(
        ...
        let registering_cost = self.call_value().egld_value();
    ...
    fn create_pair(
        ...
        // Require that operations are not paused
        ...
        require!(
            ...
            second_token_id == busd_token_id ||
            second_token_id == usdt_token_id,
        ...
        require!(
            pair_ids.contains_key(&pair_key) == false && pair_ids.contains_key(&reverse_pair_key) == false,
