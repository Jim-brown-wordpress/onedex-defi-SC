    ...
    + crate::event::EventModule
{
    ...
    fn swap_multi_tokens_fixed_input(
        ...
        for i in 0..path_len - 1 {
            ...
            amount_out = self.perform_swap_fixed_input(&token_in, &token_out, &amount_in);
            amount_in = amount_out.clone();
        }

        amount_in = amount_in_arg.clone();
        ...
        // event
        self.swap_multi_tokens_fixed_input_event(
            &self.blockchain().get_caller(),
            &(*path.get(0)),
            &amount_in,
            token_out,
    ...
    fn swap_multi_tokens_fixed_output(
        ...
        for i in 0..path_len - 1 {
            ...
            amount_in = self.perform_swap_fixed_output(&token_in, &token_out, &amount_out);
        ...
        // event
        self.swap_multi_tokens_fixed_output_event(
            &self.blockchain().get_caller(),
            &(*path.get(0)),
            &amount_in,
            token_out,
    ...
    fn perform_swap_fixed_input(
        ...
        let busd_token_id = &self.busd_token_id().get();
        let usdt_token_id = &self.usdt_token_id().get();

        let fee_input_token = if token_in == wegld_token_id || token_in == usdc_token_id || token_in == busd_token_id || token_in == usdt_token_id {
            true
        } else {
            false
        };
        ...
        // event
        self.swap_tokens_fixed_input_event(
            &self.blockchain().get_caller(),
            &token_in,
            &amount_in,
            &token_out,
    ...
    fn perform_swap_fixed_output(
        ...
        // event
        self.swap_tokens_fixed_output_event(
            &self.blockchain().get_caller(),
            &token_in,
            &amount_in,
            &token_out,
